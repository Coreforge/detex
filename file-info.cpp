...
// Uncompressed formats (texture format = pixel format).
	...
	{ DETEX_PIXEL_FORMAT_RGBA8,		1, 1,	"RGBA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 29 },
	{ DETEX_PIXEL_FORMAT_RGBA8,		1, 1,	"RGBA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 30 },
	{ DETEX_PIXEL_FORMAT_RGBA8,		1, 1,	"RGBA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 31 },
	{ DETEX_PIXEL_FORMAT_RGBA8,		1, 1,	"RGBA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 32 },
	...
	{ DETEX_PIXEL_FORMAT_BGRA8,		1, 1,	"BGRA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 87 },
	{ DETEX_PIXEL_FORMAT_BGRA8,		1, 1,	"BGRA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 88 },
	{ DETEX_PIXEL_FORMAT_BGRA8,		1, 1,	"BGRA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 91 },
	{ DETEX_PIXEL_FORMAT_BGRA8,		1, 1,	"BGRA8", "",			1, 1, 	0x1908, 0x1908, 0x1401,		"DX10", 90 },
	//{ DETEX_PIXEL_FORMAT,	1, 1,	"FLOAT_RGBA32", "",		1, 1,   0x8814,	0x1908,	0x1406,		"DX10", 2 },
// Compressed formats.
	{ DETEX_TEXTURE_FORMAT_BC1,		1, 1,	"BC1", "DXT1",			4, 4,	0x83F0, 0,	0,		"DXT1",	70 },
	{ DETEX_TEXTURE_FORMAT_BC1,		1, 1,	"BC1", "DXT1",			4, 4,	0x83F0, 0,	0,		"DXT1",	71 },
	{ DETEX_TEXTURE_FORMAT_BC1,		1, 1,	"BC1", "DXT1",			4, 4,	0x83F0, 0,	0,		"DXT1",	72 },
	{ DETEX_TEXTURE_FORMAT_BC1A,		1, 1,	"BC1A",	"DXT1A",		4, 4,	0x83F1, 0,	0, 		"", 0 },
	{ DETEX_TEXTURE_FORMAT_BC2,		1, 1,	"BC2", "DXT3",			4, 4,	0x83F2, 0,	0,		"DXT3", 0 },
 	{ DETEX_TEXTURE_FORMAT_BC3,		1, 1,	"BC3", "DXT5",			4, 4,	0x83F3, 0,	0,		"DXT5", 76 },
	{ DETEX_TEXTURE_FORMAT_BC3,		1, 1,	"BC3", "DXT5",			4, 4,	0x83F3, 0,	0,		"DXT5", 77 },
	{ DETEX_TEXTURE_FORMAT_BC3,		1, 1,	"BC3", "DXT5",			4, 4,	0x83F3, 0,	0,		"DXT5", 78 },
	...
	{ DETEX_TEXTURE_FORMAT_BPTC,		1, 1,	"BPTC", "BC7",			4, 4,	0x8E8C, 0,	0,		"DX10",	97 },
	{ DETEX_TEXTURE_FORMAT_BPTC,		1, 1,	"BPTC", "BC7",			4, 4,	0x8E8C, 0,	0,		"DX10",	99 },
